...
FRASES_CORRECTOR = [
    ...
    lambda entrega: f"Hola, si estás ahora haciendo una entrega de {entrega}, te recomiendo que mejor veas "
    + movie_generation(),
...
def vida_corrector(entrega):
    """Inteligencia artificial del corrector.

    Si le alumne está haciendo entregas en horarios estrambóticos,
    responderle con un mensaje que cuide de su salud.
    """
